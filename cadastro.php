               ...
               <input TYPE="hidden" NAME="redirect" VALUE="https://www.qualitiinternet.com.br/pagina_de_resposta.php">               
				...
				<div class="row">
					...
					<span class="your-email span6">
		   			...
		   			<span class="your-email span6">
							<input type="text" id="emailconfirm" name="emailconfirmacao" placeholder="Repita seu E-mail" class="cform-text input-text" size="40" title="Seu endereço de e-mail" required="required" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
					</span> 					
               	</div>
               	<div class="row">

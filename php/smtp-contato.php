...
if(strtolower($_SERVER['REQUEST_METHOD']) == "post"){
  ...
  ##---------------------------------------------------
	...
	$recipients ='samuel@qualitiinternet.com.br, stheffany@qualitiinternet.com.br, cristiano@qualitiinternet.com.br, max@qualitiinternet.com.br';
	# Cabeçalho do e-mail.
	$headers = array
	(
	  ...
	  'To'      => $recipients,
      'Subject' => "Formulario de Contato - QualiTi" #'TITULO DO E-MAIL' # Título do e-mail
	);
...
<html lang='pt-br'>
			...
			<div id='headerwrap'>
			<header class='clearfix'>
				<h1>Novo Cliente - Acelera QualiTi!</h1>
				<div class="row span12">
					<span class="span6" style='background-color: rgba(168,168,168,0.56)'>
						<p style='background-color: #FFFFFF'>Nome = Samuel Sardinha</p>
						<p style='background-color: #FFFFFF'>Email = samhaw@ig.com.br</p>
						<p style='background-color: #FFFFFF'>Telefone = (11) 97514-9382</p> 
						<p style='background-color: #FFFFFF'>Mensagem = Teste de envio de Mensagem!</p>
					</span>
				</div>
			</header>
			</div>

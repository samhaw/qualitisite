    ...
    <head>
    <meta charset="utf-8">
    <title>QualiTi Internet - Acesso bloqueado!</title>
    ...
    <link href="css/customizacoes-18.css" rel="stylesheet" type="text/css">
    <!-- JQuery -->
   ...
   <div id="headerwrap" style="background: url(img/foto-04.jpg); background-size: cover;">
      <header class="clearfix">
		<span id="textochamada">

          ...
          <div class="container">
            ...
            <nav class="pull-right nav-collapse collapse">
              <ul id="menu-main" class="nav">
                <li><a title="Veja todos os Planos" href="index.php">Inicio</a></li>
    ...
    <div id="headerwrap">
      <header class="clearfix">
		  <h1>Nossa equipe recebeu sua mensagem e em breve entrará em contato pelo telefone ou e-mail informado!</h1>
      </header>
    </div>
    <hr>
